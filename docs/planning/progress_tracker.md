...
当前顺序：**管状 → 平面 → 曲线 → 回转 → 自由曲面 → 研究 → 整体验收**。用户已确定管状优先，并于 2026-09-12 将回转 R01—R05 调整到 Curve C05 之后、Freeform 之前；Research 仍使用 X01—X06 编号。Planar 已登记 P01—P07 共 7 项，P07 支撑已关闭，当前没有进行中的支撑任务；AUD-01 保留的 T04、T07、T08、T12、P01、P02、P06 待验证状态不因本次关闭而撤销。后续工作台首项为 **C01**；本轮先执行用户已授权的 **AUD-02 缺陷修复与重新验证**。

本表保留规划、基础、算法、工作台和整体验收任务的唯一状态。2026-09-12 的 AUD-01 已完成检查和修改方案，确认的截层、坐标、状态、道宽、弦高及检查漏检已在 AUD-02 中修复并重新验证；其他历史任务按各自证据保留。P07 以 clean-room 独立实现的 Grid/Lines 支撑首版关闭：解析悬垂真值为 33 段、61.86 mm³，G-code 66/66 回读，7 张 Qt/OpenGL UI 图覆盖正常、错误恢复和 stale 恢复；最终 Planar 专项 211 passed，全仓 741 passed、3 skipped、130 subtests，官方质量脚本全绿。Tree/Organic、桥接专用路径、双材料不在首版范围。Generic XYZAC 仍仅为离线参考，真实控制器语义、机床标定、完整喷嘴扫掠和现场试切未验证。
...
| AUD-02 | 跨工作台缺陷修复与重新验证 | AUD-01 | 进行中 | 原始反例拒绝、正确解析/真实模型通过、旧资格失效、全仓与图文证据齐全 | [修改方案](2026-09-12_algorithm_audit_fix_plan.md)；[本轮证据](../reviews/evidence/2026-09-12_audit_fixes/) | 完成真实模型、Qt 与稳定源码回归后记录边界 | 2026-09-12 |
...
| P01 | Planar Region 与层截面 | T12 | 待验证 | 通用 Setup 接入、平面区域及实体分层、孔/岛拓扑有效 | [P01 复盘](../reviews/2026-09-12_planar_algorithm_foundation_review.md)与[证据](../reviews/evidence/2026-09-12_p01_planar/manifest.json)；稳定引用/重绑、非默认 Build CS、Stale、取消、保存、GUI/脚本/HTTP 已验证；专项 54 passed、32 subtests，质量门禁通过；[AUD-01 独立审查](../reviews/2026-09-12_project_algorithm_audit.md)发现当前缺陷，历史通过不代表当前完整资格 | 按 AUD-01 修改方案修复并重新验收；本轮只出方案 | 2026-09-12 |
| P02 | Planar Zigzag Fill | P01 | 待验证 | 轮廓/填充、带孔裁剪、路径排序、覆盖/残余/越界和材料用量可核对；离线轨迹、G-code、回读和使用手册齐全 | [P02 复盘](../reviews/2026-09-12_planar_algorithm_foundation_review.md#p02-zigzag-fill-产品接入与关闭)、[使用手册](../guides/planar_workbench_zh.md)与[证据](../reviews/evidence/2026-09-12_p02_planar/manifest.json)；真实 STEP 399 点、Qt/OpenGL 三尺寸中英截图；专项 44 passed，全仓 509 passed、3 skipped、130 subtests；六件套 readback 通过；Generic XYZAC 仅离线参考，真实机床未验证；[AUD-01 独立审查](../reviews/2026-09-12_project_algorithm_audit.md)发现当前缺陷，历史通过不代表当前完整资格 | 按 AUD-01 修改方案修复并重新验收；本轮只出方案 | 2026-09-12 |
...
| P06 | 整个 Planar 工作台验收 | P02,P03,P04,P05 | 待验证 | 四操作生成/检查/输出/回读、改参重开和帮助通过 | [P06 复盘](../reviews/2026-09-12_planar_algorithm_foundation_review.md#p06-planar-工作台阶段验收与关闭)、[使用手册](../guides/planar_workbench_zh.md)与[证据](../reviews/evidence/2026-09-12_p06_planar/manifest.json)；真实 STEP 四操作均可导出且 readback 通过；三尺寸中英 Qt/OpenGL 无碰撞、文字适配，错误态阻止导出且修复后恢复；专项 77 passed，全仓 542 passed、3 skipped、130 subtests，质量门禁通过；[AUD-01 独立审查](../reviews/2026-09-12_project_algorithm_audit.md)发现当前缺陷，历史通过不代表当前完整资格 | 按 AUD-01 修改方案修复并重新验收；本轮只出方案 | 2026-09-12 |
| P07 | Planar Grid/Lines 支撑生成 | P06 | 已完成 | 检测悬垂和空中岛；按 XY/Z 间隙生成支撑主体与接触层路径；共享 Toolpath、检查、G-code、回读、六件套、保存重开、脚本/HTTP、双语 UI、真实模型和图文手册通过 | [证据清单](../reviews/evidence/2026-09-12_p07_planar_support/manifest.json)；[P07 复盘](../reviews/2026-09-12_p07_planar_support_review.md)。`planar-support-product-v3`；解析样例 33 段、61.86 mm³、66/66 回读；支撑 travel/deposition 完整中心线段已做目标 CAD 相交检查；UI 审计 7 图且英文长诊断无横向溢出；Planar 211 passed、全仓 741 passed、3 skipped、130 subtests；官方 `scripts/check_quality.py` exit 0（Ruff/Migrated Ruff/Security Ruff/format/context/mypy 120 源码全绿）。风扇在 Z=57 mm 触发 `planar.section_endpoint_gap_exceeds_limit` Error，未导出；联合逐层调度、完整喷嘴扫掠与实机未验证 | C01：验证反向边、断链与法向歧义 | 2026-09-12 |
