...
日期：2026-09-12。Planar P01—P07 已完成。本手册覆盖 Region 截面预览、Zigzag Fill、Offset Fill、Thin Wall、Spiral，以及 buildplate-only 垂直支撑。所有结果都应先查看检查报告和回读状态；本手册不把离线参考结果描述为真实设备资格。
