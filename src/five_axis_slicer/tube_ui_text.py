...
TUBE_TEXT: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "help_create_operation": (
            "创建当前 Setup 的 Tube Thin-Wall Indexed 操作。首版界面只允许一条。"
        ),
    ...
    "en": {
        ...
        "help_create_operation": (
            "Create a Tube Thin-Wall Indexed operation for this Setup. The first UI version allows one."
        ),
...
TUBE_HELP_BINDINGS = (
    ...
    ("help_create_operation", ("create_operation_button",)),
