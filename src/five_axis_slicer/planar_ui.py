...
_TEXT = {
    "zh": {
        ...
        "resources": "路径生成需要完整且已应用的 Setup：零件、坐标、机型、喷嘴、已审阅材料和安装位置。请查看下方原因。",
    ...
    "en": {
        ...
        "resources": "Path generation requires a complete applied Setup: part, coordinates, machine, nozzle, reviewed material and placement. See the reasons below.",
